...
```text
Implement PL-0039 at <semantic-router-repo>/tools/agent/docs/plans/pl-0039-rayline-arc-orchestrator.md in a persistent goal loop. Use its checklist/evidence as memory. Treat Rung A exact-max as diagnosed; never raise the production timeout. Complete Rung B. Run Rung C only if its gate opens.
...
- `tools/agent/docs/architecture-guardrails.md`
