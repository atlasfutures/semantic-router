...
func TestProjectRaylineARCTurnsReadsTheDecodedRequest(t *testing.T) {
	...
	turns, _, err := (&OpenAIRouter{}).projectRaylineARCTurns(reqCtx, raylinearc.TurnOptions{})
	if err != nil {
...
func TestUnknownContentKindFailsClosedAndReadsAs503(t *testing.T) {
	...
	_, _, err := (&OpenAIRouter{}).projectRaylineARCTurns(reqCtx, raylinearc.TurnOptions{})
