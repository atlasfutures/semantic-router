...
var responseLegRefusals = map[string]func(*OpenAIRouter, *RequestContext) *ext_proc.ProcessingResponse{
	...
	// res_filter_jailbreak.go:76 - the response-stage guardrail blocks the output.
