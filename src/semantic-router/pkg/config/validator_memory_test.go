...
func TestValidateMemoryPerDecisionThreshold(t *testing.T) {
	...
	okCfg := &RouterConfig{}
	okCfg.Recipes = []RoutingRecipe{{Name: DefaultRecipeName, Decisions: []Decision{mkDecision("route_ok", 0.72)}}}
	...
	badCfg := &RouterConfig{}
	badCfg.Recipes = []RoutingRecipe{{Name: DefaultRecipeName, Decisions: []Decision{mkDecision("route_bad", 2.0)}}}
