...
def _normalize_existing_provider_model(
    ...
    _set_if_missing(
        provider_model, "provider_preferences", access.get("provider_preferences")
    )
    _set_if_missing(
        provider_model, "external_model_ids", model.get("external_model_ids")
    )
    _set_if_missing(
        provider_model, "provider_preferences", model.get("provider_preferences")
    )
...
def _migrate_legacy_flat_model_bindings(
    ...
    for model_name, raw_entry in legacy_model_config.items():
        ...
        _set_if_missing(
            provider_model, "provider_preferences", raw_entry.get("provider_preferences")
        )
        _set_if_missing(
...
def _convert_model_targets_to_provider_models(
    ...
    for model_name, raw_target in model_targets.items():
        ...
        _set_if_missing(
            provider_model, "provider_preferences", raw_target.get("provider_preferences")
        )
