...
"""Build the aggregate-only AGT018 comparison receipt from private inputs."""
...
from openrouter_kv_cache_successor_reporting import build_report
...
def _load(path: str) -> dict[str, Any]:
    ...
    if not isinstance(decoded, dict):
        raise RuntimeError("AGT018 report input must be a JSON object")
    return decoded
