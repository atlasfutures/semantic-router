...
PERF023 = ScaleoutRunContract(
    run_id=PERF023_RUN_ID,
    packet_manifest_sha256=PERF022.packet_manifest_sha256,
    corpus_sha256=PERF022.corpus_sha256,
    topology_sha256=PERF022.topology_sha256,
    cells=PERF022.cells,
    compose_project_prefix="rayline-affinity-perf023",
    temporary_prefix="rayline-perf023-",
    budget=BudgetContract(
        run_id=PERF023_RUN_ID,
        previous_conservative_usd=62.82257284218463,
        authorized_cumulative_usd=134.31282402,
        packet_ceiling_usd=14.0,
        required_reserve_usd=3.0,
        maximum_paid_wall_seconds=MAXIMUM_PAID_WALL_SECONDS,
...
PERF024 = ScaleoutRunContract(
    run_id=PERF024_RUN_ID,
    packet_manifest_sha256=PERF023.packet_manifest_sha256,
    corpus_sha256=PERF023.corpus_sha256,
    topology_sha256=PERF023.topology_sha256,
    cells=PERF023.cells,
    compose_project_prefix="rayline-affinity-perf024",
    temporary_prefix="rayline-perf024-",
    budget=BudgetContract(
        run_id=PERF024_RUN_ID,
        previous_conservative_usd=65.61784324218463,
        authorized_cumulative_usd=134.31282402,
        packet_ceiling_usd=14.0,
        required_reserve_usd=3.0,
        maximum_paid_wall_seconds=MAXIMUM_PAID_WALL_SECONDS,
...
# PERF022, PERF023, and PERF024 are closed after their one launches. A
# successor must complete a new external authorization chain.
